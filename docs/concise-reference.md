...
- [Statements](#statements)
  ...
  - [Yield statement](#yield-statement)
    - [Benefits of yield:](#benefits-of-yield)
...
- [Pattern matching](#pattern-matching)
  ...
  - [List patterns (C# 11.0+)](#list-patterns-c-110)
  - [Discard pattern](#discard-pattern)
- [Exceptions](#exceptions)
  - [Try-catch-finally](#try-catch-finally)
  - [When to use different Exception approaches](#when-to-use-different-exception-approaches)
  - [Throwing Exceptions](#throwing-exceptions)
  - [Guidelines for Exception types:](#guidelines-for-exception-types)
  - [Custom Exceptions](#custom-exceptions)
  - [Performance considerations](#performance-considerations)
- [Asynchronous Programming](#asynchronous-programming)
  - [When to use asynchronous programming](#when-to-use-asynchronous-programming)
  - [Async and await basics](#async-and-await-basics)
  - [Guidelines for async methods:](#guidelines-for-async-methods)
  ...
  - [Async exception handling best practices:](#async-exception-handling-best-practices)
  - [Cancellation in async operations](#cancellation-in-async-operations)
  - [ValueTask and async streams (C# 8.0+)](#valuetask-and-async-streams-c-80)
